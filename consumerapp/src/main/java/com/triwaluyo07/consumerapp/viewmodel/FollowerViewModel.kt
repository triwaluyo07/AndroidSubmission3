package com.triwaluyo07.consumerapp.viewmodel
...
class FollowerViewModel : ViewModel() {
    ...
    fun setListFollower(username: String){
        ...
        client.addHeader("Authorization", "token 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")
            ...
            override fun onSuccess(statusCode: Int,headers: Array<out Header>,responseBody: ByteArray)
            {
                ...
                try
                {
                    ...
                    for (i in 0 until jsonArray.length())
                    {
                        ...
                        val listFollowers = UserData(login,avatarUrl,url)
                        listUsers.add(listFollowers)
                    }
